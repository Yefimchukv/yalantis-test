...
internal enum L10n {
  internal enum Constants {
    internal enum Cells {
      /// settingsCell
      internal static let settingsCell = L10n.tr("Constants", "cells.settingsCell")
    }
    internal enum SettingsKey {
      /// straightPredictions
      internal static let straightPredictions = L10n.tr("Constants", "settingsKey.straightPredictions")
    }
    internal enum SettingsName {
      /// Straight Predictions
      internal static let straightPredictions = L10n.tr("Constants", "settingsName.straightPredictions")
    }
  }
